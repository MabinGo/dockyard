...
func SetRouters(m *macaron.Macaron) {
	...
	m.Group("/web", func() {
		...
		m.Get("/:type/packages", handler.GetAllPackagesV1Handler)
		m.Get("/:type/:namespace/:repository", handler.GetRepositoryPageV1Handler)

		m.Group("/v1", func() {
			m.Get("/:type/:namespace/:repository/:os/:arch/:app/:tag/file/:filename", handler.AppGetFileV1Handler)
			...
			m.Post("/:type/:namespace/:repository/:package", handler.PostPackageRESTV1Handler)
			...
			m.Delete("/:type/:namespace/:repository/:package", handler.DeletePacakgeRESTV1Handler)

			m.Post("/:type/:namespace/:repository/:package/manifests", handler.PostManifestRESTV1Handler)
			m.Get("/:type/:namespace/:repository/:package/manifests", handler.GetManifestRESTV1Handler)
			m.Put("/:type/:namespace/:repository/:package/manifests", handler.PutManifestRESTV1Handler)
			m.Delete("/:type/:namespace/:repository/:package/manifests", handler.DeleteManifestRESTV1Handler)
		})
	})
